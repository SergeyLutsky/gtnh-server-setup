...
assert_success "six-mod catalogue with retired-mod migration validates" mod_catalogue_validate "$mod_catalogue"
all_mods="$(mod_resolve "$mod_catalogue" 2.8.4 all)"
assert_eq "6" "$(jq length <<<"$all_mods")" "all six offered mods resolve for GTNH 2.8.4"
